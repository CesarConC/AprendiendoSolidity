...
contract ValueTypes {
    ...
    */
    ...
    int public masxInt = type(int).max;
}
...
contract Contador {
    ...
    function getContador() external view returns (uint) {
        return contador;
    }
}
...
contract Errores {
    function testRequiere(uint _x) public pure {
        require(_x < 10, "x > 10");
        _x = 1;
...
contract DiccionarioIterable {
    ...
    function fisrt() external view returns (uint) {
